...
@DisplayName("Unit Test: PostTask - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                PostTask servlet = null;
                try {
                    for (Constructor<?> ctor : PostTask.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (PostTask) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : PostTask.class.getDeclaredMethods()) {
