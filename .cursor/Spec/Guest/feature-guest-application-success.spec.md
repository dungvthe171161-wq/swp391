# Feature: Guest xem trang nop don thanh cong
Status: Approved
...
## Luong chinh
1. Sau khi application duoc luu thanh cong, controller redirect den `/Views/Success.jsp`.
...
- [ ] Co link quay lai homepage neu UI can.
