...
@DisplayName("Unit Test: CreateContractController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                CreateContractController servlet = null;
                try {
                    for (Constructor<?> ctor : CreateContractController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (CreateContractController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : CreateContractController.class.getDeclaredMethods()) {
