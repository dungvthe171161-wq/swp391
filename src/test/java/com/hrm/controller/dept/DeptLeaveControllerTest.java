...
@DisplayName("Unit Test: DeptLeaveController - Mocked Servlet")
public class DeptLeaveControllerTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                DeptLeaveController servlet = null;
                try {
                    for (Constructor<?> ctor : DeptLeaveController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (DeptLeaveController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : DeptLeaveController.class.getDeclaredMethods()) {
