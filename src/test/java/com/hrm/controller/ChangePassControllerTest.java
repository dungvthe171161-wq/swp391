...
@DisplayName("Unit Test: ChangePassController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                ChangePassController servlet = null;
                try {
                    for (Constructor<?> ctor : ChangePassController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (ChangePassController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : ChangePassController.class.getDeclaredMethods()) {
