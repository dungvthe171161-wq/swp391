...
@DisplayName("Unit Test: RoleServlet - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                RoleServlet servlet = null;
                try {
                    for (Constructor<?> ctor : RoleServlet.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (RoleServlet) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : RoleServlet.class.getDeclaredMethods()) {
