...
@DisplayName("Unit Test: RegisterController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                RegisterController servlet = null;
                try {
                    for (Constructor<?> ctor : RegisterController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (RegisterController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : RegisterController.class.getDeclaredMethods()) {
