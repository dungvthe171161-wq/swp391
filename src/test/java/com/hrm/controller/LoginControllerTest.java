...
@DisplayName("Unit Test: LoginController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                LoginController servlet = null;
                try {
                    for (Constructor<?> ctor : LoginController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (LoginController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : LoginController.class.getDeclaredMethods()) {
