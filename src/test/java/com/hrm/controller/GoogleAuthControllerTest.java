...
@DisplayName("Unit Test: GoogleAuthController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                GoogleAuthController servlet = null;
                try {
                    for (Constructor<?> ctor : GoogleAuthController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (GoogleAuthController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : GoogleAuthController.class.getDeclaredMethods()) {
