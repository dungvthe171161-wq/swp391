...
@DisplayName("Unit Test: ContractListController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                ContractListController servlet = null;
                try {
                    for (Constructor<?> ctor : ContractListController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (ContractListController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : ContractListController.class.getDeclaredMethods()) {
