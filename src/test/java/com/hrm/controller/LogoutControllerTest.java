...
@DisplayName("Unit Test: LogoutController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                LogoutController servlet = null;
                try {
                    for (Constructor<?> ctor : LogoutController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (LogoutController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : LogoutController.class.getDeclaredMethods()) {
