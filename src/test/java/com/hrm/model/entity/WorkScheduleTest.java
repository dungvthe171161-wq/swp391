...
@DisplayName("Unit Test: WorkSchedule - reflection-based 100% coverage")
public class WorkScheduleTest {
    ...
    void testAllMethodsAndConstructors() {
        try {
            WorkSchedule obj = new WorkSchedule();
            assertNotNull(obj);
            
            // All setter/getter calls via reflection
            for (Method m : WorkSchedule.class.getMethods()) {
            ...
            for (Constructor<?> ctor : WorkSchedule.class.getConstructors()) {
