...
@DisplayName("Unit Test: PayrollDeductionApiController - Mocked Servlet")
public class PayrollDeductionApiControllerTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                PayrollDeductionApiController servlet = null;
                try {
                    for (Constructor<?> ctor : PayrollDeductionApiController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (PayrollDeductionApiController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : PayrollDeductionApiController.class.getDeclaredMethods()) {
