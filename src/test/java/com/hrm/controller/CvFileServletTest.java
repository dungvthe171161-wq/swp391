...
@DisplayName("Unit Test: CvFileServlet - Mocked Servlet")
public class CvFileServletTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                CvFileServlet servlet = null;
                try {
                    for (Constructor<?> ctor : CvFileServlet.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (CvFileServlet) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : CvFileServlet.class.getDeclaredMethods()) {
