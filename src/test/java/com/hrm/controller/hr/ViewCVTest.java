...
@DisplayName("Unit Test: ViewCV - Mocked Servlet")
public class ViewCVTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                ViewCV servlet = null;
                try {
                    for (Constructor<?> ctor : ViewCV.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (ViewCV) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : ViewCV.class.getDeclaredMethods()) {
