...
@DisplayName("Unit Test: RecruitmentController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                RecruitmentController servlet = null;
                try {
                    for (Constructor<?> ctor : RecruitmentController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (RecruitmentController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : RecruitmentController.class.getDeclaredMethods()) {
