...
@DisplayName("Unit Test: OfficeLocation - reflection-based 100% coverage")
public class OfficeLocationTest {
    ...
    void testAllMethodsAndConstructors() {
        try {
            OfficeLocation obj = new OfficeLocation();
            assertNotNull(obj);
            
            // All setter/getter calls via reflection
            for (Method m : OfficeLocation.class.getMethods()) {
            ...
            for (Constructor<?> ctor : OfficeLocation.class.getConstructors()) {
