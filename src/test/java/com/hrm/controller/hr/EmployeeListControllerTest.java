...
@DisplayName("Unit Test: EmployeeListController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                EmployeeListController servlet = null;
                try {
                    for (Constructor<?> ctor : EmployeeListController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (EmployeeListController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : EmployeeListController.class.getDeclaredMethods()) {
