...
@DisplayName("Unit Test: InterviewScheduleController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                InterviewScheduleController servlet = null;
                try {
                    for (Constructor<?> ctor : InterviewScheduleController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (InterviewScheduleController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : InterviewScheduleController.class.getDeclaredMethods()) {
