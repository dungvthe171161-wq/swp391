...
@DisplayName("Unit Test: EmployeePortalController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                EmployeePortalController servlet = null;
                try {
                    for (Constructor<?> ctor : EmployeePortalController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (EmployeePortalController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : EmployeePortalController.class.getDeclaredMethods()) {
