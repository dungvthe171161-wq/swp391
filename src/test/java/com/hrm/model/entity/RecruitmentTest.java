...
@DisplayName("Unit Test: Recruitment - reflection-based 100% coverage")
public class RecruitmentTest {
    ...
    void testAllMethodsAndConstructors() {
        try {
            ...
            for (Method m : Recruitment.class.getMethods()) {
            ...
            for (Constructor<?> ctor : Recruitment.class.getConstructors()) {
