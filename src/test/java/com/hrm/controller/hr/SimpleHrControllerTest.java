...
@DisplayName("Unit Test: SimpleHrController - Mocked Servlet")
public class SimpleHrControllerTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                SimpleHrController servlet = null;
                try {
                    for (Constructor<?> ctor : SimpleHrController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (SimpleHrController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : SimpleHrController.class.getDeclaredMethods()) {
