...
@DisplayName("Unit Test: HomepageController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                HomepageController servlet = null;
                try {
                    for (Constructor<?> ctor : HomepageController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (HomepageController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : HomepageController.class.getDeclaredMethods()) {
