...
@DisplayName("Unit Test: OfferManagementController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                OfferManagementController servlet = null;
                try {
                    for (Constructor<?> ctor : OfferManagementController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (OfferManagementController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : OfferManagementController.class.getDeclaredMethods()) {
