...
@DisplayName("Unit Test: HrStaffHomeController - Mocked Servlet")
public class HrStaffHomeControllerTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                HrStaffHomeController servlet = null;
                try {
                    for (Constructor<?> ctor : HrStaffHomeController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (HrStaffHomeController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : HrStaffHomeController.class.getDeclaredMethods()) {
