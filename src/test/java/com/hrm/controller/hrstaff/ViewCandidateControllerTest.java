...
@DisplayName("Unit Test: ViewCandidateController - Mocked Servlet")
public class ViewCandidateControllerTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                ViewCandidateController servlet = null;
                try {
                    for (Constructor<?> ctor : ViewCandidateController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (ViewCandidateController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : ViewCandidateController.class.getDeclaredMethods()) {
