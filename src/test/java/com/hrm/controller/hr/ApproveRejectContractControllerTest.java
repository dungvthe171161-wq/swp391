...
@DisplayName("Unit Test: ApproveRejectContractController - Mocked Servlet")
public class ApproveRejectContractControllerTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                ApproveRejectContractController servlet = null;
                try {
                    for (Constructor<?> ctor : ApproveRejectContractController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (ApproveRejectContractController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : ApproveRejectContractController.class.getDeclaredMethods()) {
