...
@DisplayName("Unit Test: NotificationController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                NotificationController servlet = null;
                try {
                    for (Constructor<?> ctor : NotificationController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (NotificationController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : NotificationController.class.getDeclaredMethods()) {
