# Feature: Guest nop don ung tuyen
Status: Approved
...
3. Sau khi dang nhap thanh cong, user quay ve `/homepage` theo luong auth hien tai.
4. Neu can quay lai job cu sau login, bo sung `returnUrl` trong feature sau.
...
- [ ] Can nhac `returnUrl` de quay lai job dang xem sau login.
