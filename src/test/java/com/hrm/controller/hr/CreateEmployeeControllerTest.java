...
@DisplayName("Unit Test: CreateEmployeeController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                CreateEmployeeController servlet = null;
                try {
                    for (Constructor<?> ctor : CreateEmployeeController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (CreateEmployeeController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : CreateEmployeeController.class.getDeclaredMethods()) {
