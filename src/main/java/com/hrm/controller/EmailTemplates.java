...
public final class EmailTemplates {
    ...
    public static String taskDeadlineReminder(String employeeName, String taskTitle,
        ...
        return taskEmail(
                ...
                "Việc cần làm", "Đăng nhập WorkMate để cập nhật trạng thái hoặc nộp kết quả công việc.",
                "Kiểm tra công việc", taskUrl
        );
    }

    public static String attendanceLogged(String employeeName, String actionType, String timeString) {
        String actionLabel = "checkIn".equals(actionType) ? "Vào ca (Check-in)" : "Ra ca (Check-out)";
        String statusColor = "checkIn".equals(actionType) ? GREEN_ACCENT : "#b45309";
        
        return applicationStatusEmail(
                "Thông báo chấm công",
                "Chấm công thành công",
                "Hệ thống đã ghi nhận dữ liệu chấm công của bạn trên WorkMate.",
                actionLabel,
                statusColor,
                "Chi tiết ghi nhận",
                "Thời gian: " + timeString + "<br>Phương thức: Định vị GPS",
                employeeName,
    ...
    private static String taskEmail(String eyebrow, String headline, String lead,
        ...
        String safeName = escape(firstNonBlank(employeeName, "Nhân viên WorkMate"));
        ...
        String safeNote = escape(firstNonBlank(noteBody, "Xem chi tiết công việc trên WorkMate"))
                .replace("\r\n", "<br>").replace("\n", "<br>");
                    ...
                    <table role="presentation" width="100%%" cellspacing="0" cellpadding="0" style="background:%s;padding:32px 12px;">
                        <tr><td align="center">
                            <table role="presentation" width="100%%" cellspacing="0" cellpadding="0" style="max-width:640px;background:%s;border-radius:16px;overflow:hidden;box-shadow:0 8px 24px rgba(0,0,0,0.10);">
                                ...
                                <tr><td style="background:%s;padding:20px 32px;color:rgba(255,255,255,0.70);font-size:13px;line-height:1.6;">Email này được gửi tự động từ hệ thống WorkMate. Vui lòng không trả lời trực tiếp email này.</td></tr>
                            </table>
                        </td></tr>
                    </table>
                </body></html>
                                ...
                                <table role="presentation" width="100%%" cellspacing="0" cellpadding="0" style="max-width:640px; background:%s; border-radius:18px; overflow:hidden; box-shadow:0 8px 24px rgba(0,0,0,0.10);">
                                    ...
                                    <tr>
                                        <td style="padding:32px;">
                                            ...
                                            <span style="display:inline-block; background:%s; color:%s; text-decoration:none; font-size:15px; font-weight:700; padding:13px 22px; border-radius:999px;">WorkMate đồng hành cùng bạn</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="background:%s; padding:22px 32px; color:%s; font-size:13px; line-height:1.6;">
                                            Email này được gửi tự động từ hệ thống WorkMate. Vui lòng không trả lời trực tiếp email này.
                                        </td>
                                    </tr>
                                </table>
                            </td>
