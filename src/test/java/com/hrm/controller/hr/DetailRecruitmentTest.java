...
@DisplayName("Unit Test: DetailRecruitment - Mocked Servlet")
public class DetailRecruitmentTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                DetailRecruitment servlet = null;
                try {
                    for (Constructor<?> ctor : DetailRecruitment.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (DetailRecruitment) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : DetailRecruitment.class.getDeclaredMethods()) {
