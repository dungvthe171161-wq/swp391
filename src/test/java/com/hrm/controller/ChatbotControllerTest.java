...
@DisplayName("Unit Test: ChatbotController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                ChatbotController servlet = null;
                try {
                    for (Constructor<?> ctor : ChatbotController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (ChatbotController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : ChatbotController.class.getDeclaredMethods()) {
