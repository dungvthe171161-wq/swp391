...
@DisplayName("Unit Test: DetailWaitingRecruitment - Mocked Servlet")
public class DetailWaitingRecruitmentTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                DetailWaitingRecruitment servlet = null;
                try {
                    for (Constructor<?> ctor : DetailWaitingRecruitment.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (DetailWaitingRecruitment) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : DetailWaitingRecruitment.class.getDeclaredMethods()) {
