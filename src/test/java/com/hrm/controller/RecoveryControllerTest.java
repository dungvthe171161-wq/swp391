...
@DisplayName("Unit Test: RecoveryController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                RecoveryController servlet = null;
                try {
                    for (Constructor<?> ctor : RecoveryController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (RecoveryController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : RecoveryController.class.getDeclaredMethods()) {
