...
@DisplayName("Unit Test: ChangePassREController - Mocked Servlet")
public class ChangePassREControllerTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                ChangePassREController servlet = null;
                try {
                    for (Constructor<?> ctor : ChangePassREController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (ChangePassREController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : ChangePassREController.class.getDeclaredMethods()) {
