...
@DisplayName("Unit Test: LeaveApprovalController - Mocked Servlet")
public class LeaveApprovalControllerTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                LeaveApprovalController servlet = null;
                try {
                    for (Constructor<?> ctor : LeaveApprovalController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (LeaveApprovalController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : LeaveApprovalController.class.getDeclaredMethods()) {
