...
CREATE TABLE IF NOT EXISTS Task (
    ...
    StartDate DATETIME,
    DueDate DATETIME,
    Status ENUM('Waiting','In Progress','Submitted','Approved','Rejected','Overdue','Cancelled') DEFAULT 'Waiting',
...
CREATE TABLE IF NOT EXISTS assignList (
    ...
    TaskId INT NOT NULL,
    EmpId INT NOT NULL,
    Status ENUM('Waiting','In Progress','Submitted','Approved','Rejected') NOT NULL DEFAULT 'Waiting',
    SubmittedAt DATETIME NULL,
    ApprovedAt DATETIME NULL,
    Feedback TEXT NULL,
    DeadlineReminderSentAt DATETIME NULL,
...
VALUES
('Prepare monthly HR report', 'Compile staff attendance & leave data', 1, '2025-09-01', '2025-09-05', 'Approved'),
...
('Design brochure', 'Design marketing brochure for new campaign', 7, '2025-09-01', '2025-09-10', 'Approved'),
