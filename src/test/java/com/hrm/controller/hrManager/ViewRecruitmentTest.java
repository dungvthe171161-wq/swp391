...
@DisplayName("Unit Test: ViewRecruitment - Mocked Servlet")
public class ViewRecruitmentTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                ViewRecruitment servlet = null;
                try {
                    for (Constructor<?> ctor : ViewRecruitment.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (ViewRecruitment) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : ViewRecruitment.class.getDeclaredMethods()) {
