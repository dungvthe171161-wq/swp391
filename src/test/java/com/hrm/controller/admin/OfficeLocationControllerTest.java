...
@DisplayName("Unit Test: OfficeLocationController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                OfficeLocationController servlet = null;
                try {
                    for (Constructor<?> ctor : OfficeLocationController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (OfficeLocationController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : OfficeLocationController.class.getDeclaredMethods()) {
