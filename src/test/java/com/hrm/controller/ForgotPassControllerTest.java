...
@DisplayName("Unit Test: ForgotPassController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                ForgotPassController servlet = null;
                try {
                    for (Constructor<?> ctor : ForgotPassController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (ForgotPassController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : ForgotPassController.class.getDeclaredMethods()) {
