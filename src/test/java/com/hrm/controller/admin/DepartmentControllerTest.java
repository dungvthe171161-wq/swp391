...
@DisplayName("Unit Test: DepartmentController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                DepartmentController servlet = null;
                try {
                    for (Constructor<?> ctor : DepartmentController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (DepartmentController) ctor.newInstance(args);
