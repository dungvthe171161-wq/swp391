...
@DisplayName("Unit Test: PayrollCalculateController - Mocked Servlet")
public class PayrollCalculateControllerTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                PayrollCalculateController servlet = null;
                try {
                    for (Constructor<?> ctor : PayrollCalculateController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (PayrollCalculateController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : PayrollCalculateController.class.getDeclaredMethods()) {
