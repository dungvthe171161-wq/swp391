...
@DisplayName("Unit Test: DeptWorkScheduleController - Mocked Servlet")
public class DeptWorkScheduleControllerTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                DeptWorkScheduleController servlet = null;
                try {
                    for (Constructor<?> ctor : DeptWorkScheduleController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (DeptWorkScheduleController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : DeptWorkScheduleController.class.getDeclaredMethods()) {
