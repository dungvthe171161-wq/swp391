...
@DisplayName("Unit Test: ProfilepageController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                ProfilepageController servlet = null;
                try {
                    for (Constructor<?> ctor : ProfilepageController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (ProfilepageController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : ProfilepageController.class.getDeclaredMethods()) {
