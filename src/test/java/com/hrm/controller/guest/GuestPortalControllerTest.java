...
@DisplayName("Unit Test: GuestPortalController - Mocked Servlet")
public class GuestPortalControllerTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                GuestPortalController servlet = null;
                try {
                    for (Constructor<?> ctor : GuestPortalController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (GuestPortalController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : GuestPortalController.class.getDeclaredMethods()) {
