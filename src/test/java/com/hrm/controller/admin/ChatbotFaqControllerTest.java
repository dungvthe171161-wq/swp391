...
@DisplayName("Unit Test: ChatbotFaqController - Mocked Servlet")
public class ChatbotFaqControllerTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                ChatbotFaqController servlet = null;
                try {
                    for (Constructor<?> ctor : ChatbotFaqController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (ChatbotFaqController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : ChatbotFaqController.class.getDeclaredMethods()) {
