...
@DisplayName("Unit Test: DBConnectionTest - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                DBConnectionTest servlet = null;
                try {
                    for (Constructor<?> ctor : DBConnectionTest.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (DBConnectionTest) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : DBConnectionTest.class.getDeclaredMethods()) {
