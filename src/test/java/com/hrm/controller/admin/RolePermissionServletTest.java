...
@DisplayName("Unit Test: RolePermissionServlet - Mocked Servlet")
public class RolePermissionServletTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                RolePermissionServlet servlet = null;
                try {
                    for (Constructor<?> ctor : RolePermissionServlet.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (RolePermissionServlet) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : RolePermissionServlet.class.getDeclaredMethods()) {
