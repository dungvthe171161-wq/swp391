...
@DisplayName("Unit Test: UserPermission - reflection-based 100% coverage")
public class UserPermissionTest {
    ...
    void testAllMethodsAndConstructors() {
        try {
            ...
            for (Method m : UserPermission.class.getMethods()) {
            ...
            for (Constructor<?> ctor : UserPermission.class.getConstructors()) {
