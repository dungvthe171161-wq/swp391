...
@DisplayName("Unit Test: DetailRecruitmentCreate - Mocked Servlet")
public class DetailRecruitmentCreateTest {
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                DetailRecruitmentCreate servlet = null;
                try {
                    for (Constructor<?> ctor : DetailRecruitmentCreate.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (DetailRecruitmentCreate) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : DetailRecruitmentCreate.class.getDeclaredMethods()) {
