...
@DisplayName("Unit Test: DeptController - Mocked Servlet")
    ...
    void testServletExecution() {
        try {
            ...
            try (MockedStatic<com.hrm.dao.DBConnection> mockedDb = mockStatic(com.hrm.dao.DBConnection.class)) {
                ...
                DeptController servlet = null;
                try {
                    for (Constructor<?> ctor : DeptController.class.getDeclaredConstructors()) {
                        try {
                            ctor.setAccessible(true);
                            Object[] args = new Object[ctor.getParameterCount()];
                            servlet = (DeptController) ctor.newInstance(args);
                ...
                if (servlet != null) {
                    ...
                    for (Method m : DeptController.class.getDeclaredMethods()) {
